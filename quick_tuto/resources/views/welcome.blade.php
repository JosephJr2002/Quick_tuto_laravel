...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-info">
          <div class="container">
            <a class="navbar-brand  btn-outline-danger" href="#"> <b>Blog de brice </b>  </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a class="nav-link  btn btn-outline-danger" href="#">A propos de brice</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link btn btn-outline-danger" href="#">Contacts de brice</a>
                </li>
              </ul>
